    ...
    Box(
        ...
        Column {
            ...
            (0 until 3).forEach { index ->
                val categoryOrNull = userInfo.category.getOrNull(index)

                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(
                        text = stringResource(R.string.onboarding_info_category_rank, index + 1),
                    ...
                    if (categoryOrNull != null) {
                        ...
                        Text(
                            text = stringResource(R.string.onboarding_info_category_rank_empty),
                            style = CertiTheme.typography.caption.semibold_14,
                            color = CertiTheme.colors.gray400,
