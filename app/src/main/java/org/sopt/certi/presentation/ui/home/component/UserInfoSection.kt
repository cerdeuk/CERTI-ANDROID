...
fun UserInfoSection(
    ...
    Column(
        ...
        Row(
            ...
            Spacer(modifier = Modifier.width(screenWidthDp(0.02f)))
        ...
        Spacer(modifier = Modifier.height(screenHeightDp(0.019f)))
        ...
        Spacer(modifier = Modifier.height(screenHeightDp(0.012f)))
